    ...
    <header className="bg-slate-800 text-white shadow-md">
      <div className="flex items-center justify-between px-6 py-4 max-w-screen-xl mx-auto w-full flex-wrap">
        ...
        <nav className="hidden md:flex gap-8 items-center">
          ...
          <Link to="/invest" className="hover:text-blue-400 transition-colors">Invest</Link>
        </nav>
      ...
      {isMenuOpen && (
        <div className="md:hidden px-4 pb-4 pt-1 bg-slate-900">
          <nav className="flex flex-col space-y-3">
            <Link to="/dashboard" className="py-2 px-3 hover:bg-slate-700 rounded">Dashboard</Link>
            <Link to="/invest" className="py-2 px-3 hover:bg-slate-700 rounded">Invest</Link>
          </nav>
        </div>
      )}
    </header>
